...
<article>
    ...
    <form action="?ctl=add_khach_hang" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col">
                <div class="form-group">
                    <label for="">Mã khách hàng</label>
                    <input class="form-control" type="text" name="ma_kh" placeholder="Mã khách hàng" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="">Họ và tên</label>
                    <input class="form-control" type="text" name="ho_ten" placeholder="Họ và tên" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
        ...
        <button class="btn" type="submit" name="btn_add">Thêm</button>
